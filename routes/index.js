...
router.get('/', function (req, res) {
  res.render('index', { title: 'Minerals App', user : req.user });
});

router.get('/register', function(req, res) {
  res.render('register', { title: 'Minerals App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Minerals App Login', user : req.user });
 });
